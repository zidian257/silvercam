...
2. **有人声的停顿：默认取一处、≤6s。** desc 标了人声区间（如「1545–1675s 有人声」）就在区间内抽帧，挑一个表情/互动自然的 beat——这是全片唯一的人味镜头，别整段塞（拖节奏，也有隐私顾虑）。抽帧后画面实在不可用才允许放弃，并在提交说明里写明原因。安静的停顿看画面定夺（补给/拍照/看风景留 2–3s 或跳过）。
